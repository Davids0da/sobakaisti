    ...
    return <div>
        <div className={`flex flex-col items-center pt-2 -mt-11 hover:mt-0 transition-all max-[768px]:mt-0`}>
            <div className={`text-lg w-full flex justify-center mb-2.5 font-bold space-x-5 border-b-4 border-black font-sobakaisti`}>
                <Link to={`/game/litero-game`}><h1 className="mb-2 hover:text-red-500">LITERO-IGRA</h1> </Link>
                <Link to={`/game/txt`}> <h1 className="mb-2 hover:text-red-500">TXT</h1> </Link>
                <Link to={`/game/shop`}><h1 className="mb-2 hover:text-red-500">DUĆAN</h1> </Link>
                <Link to={`/game/contact`} className="mb-2 hover:text-red-500"> <h1>KONTAKT</h1> </Link>
            </div>
