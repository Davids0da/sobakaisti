...
//
//
// <div className="border-2 p-4 border-black mb-4">
//     <h1></h1>
//     <p></p>
//     <p></p>
// </div>
...
export const ArticleInCard:FC<ArticleInCardProps> = ({article}) => {
    return <article
        ...
        <div className="flex justify-between items-center mb-5 text-gray-500">
            ...
            <span className="text-sm">{article.attributes.createdAt}</span>
        </div>
        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">{article.attributes.title}</a></h2>
        <p className="mb-5 font-light text-gray-500 dark:text-gray-400">{article.attributes.content}</p>
