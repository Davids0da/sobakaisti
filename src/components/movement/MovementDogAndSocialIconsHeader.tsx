    ...
    return <div>
        <div className={`flex flex-col items-center pt-2 -mt-9 hover:mt-0 transition-all max-[768px]:mt-0`}>
            <div className={`text-sm w-full flex justify-center mb-2.5 font-bold space-x-5 max-[768px]:space-x-4 border-b-4 border-black`}>
                <Link to={`/movement/manifesto`}><h1 className="mb-2 hover:text-cyan-600">MANIFEST</h1> </Link>
                <Link to={`/movement/arts`}> <h1 className="mb-2 hover:text-cyan-600">RADOVI</h1> </Link>
                <Link to={`/movement/authors`}><h1 className="mb-2 hover:text-cyan-600">AUTORI</h1> </Link>
                <Link to={`/movement/publications`} className="mb-2 hover:text-cyan-600"> <h1>IZDANJA</h1> </Link>
                <Link to={`/movement/contact`}><h1 className="mb-2 hover:text-cyan-600">KONTAKT</h1> </Link>
            </div>
