...
export const AuthorCircleForContactPage:FC<UserProps> = ({user}) => {
    const getInitialsWithDots = (user:UserProps) => {
        return user.first_name[0].toUpperCase() + "." + user.last_name[0].toUpperCase() + '.'
    }

    return <button className="mx-1 opacity-80 border group rounded-full w-11 h-11 grid place-items-center border-black hover:border-fuchsia-600 hover:border-2">
